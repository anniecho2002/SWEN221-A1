...
public class Board {
	 ...
	 *         otherwise.
	 *         
	 * Compares the current board to the original board,
	 * if they are the same, then the game is finished
	 */
	public boolean isFinished() {
		original = new Board(img, width, dimension);
		if(original.toString().equals(this.toString())) {
			return true;
		}
		return false;
	}
